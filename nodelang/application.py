...
STYLESHEET = r"""
*{box-sizing:border-box}html,body{width:100%;height:100%;margin:0;overflow:hidden;background:var(--bg);color:var(--ink);font-family:Inter,system-ui,sans-serif;font-size:13px}button,input{font:inherit;letter-spacing:0}.archhub-app{width:100vw;height:100vh;display:grid;grid-template-columns:292px minmax(0,1fr);grid-template-rows:minmax(0,1fr) 22px;background:var(--bg);overflow:hidden}.sidebar{grid-column:1;grid-row:1;display:grid;grid-template-columns:56px 236px;min-height:0;background:var(--bg-panel);border-right:1px solid var(--line)}.icon-rail{background:var(--bg-deep);border-right:1px solid var(--line);display:flex;flex-direction:column;align-items:stretch;padding:12px 0 10px;gap:2px}.rail-button{min-height:48px;border:0;background:transparent;color:var(--ink-soft);display:flex;align-items:center;justify-content:center;cursor:pointer;font-family:ui-monospace,monospace;font-size:9px;text-transform:uppercase}.rail-button:hover{background:var(--bg-soft);color:var(--ink)}.rail-button[data-active="true"]{color:var(--accent);background:var(--accent-soft);border-left:2px solid var(--accent)}.rail-spacer{flex:1}.library-panel{display:flex;flex-direction:column;min-width:0;overflow:hidden}.panel-title{height:48px;padding:17px 14px 10px;border-bottom:1px solid var(--line);font-family:ui-monospace,monospace;font-size:9px;letter-spacing:.18em;color:var(--ink-muted)}.library-list{overflow:auto;padding:8px}.library-row{width:100%;border:0;background:transparent;color:var(--ink-soft);padding:7px 9px;text-align:left;display:flex;align-items:center;gap:8px;border-radius:5px;cursor:pointer;font-size:12px}.library-row:hover{background:var(--bg-soft);color:var(--ink)}.library-dot{width:7px;height:7px;border-radius:50%;background:var(--accent);flex:0 0 auto}.workspace{grid-column:2;grid-row:1;min-width:0;min-height:0;display:grid;grid-template-columns:minmax(0,1fr) 320px;grid-template-rows:36px minmax(0,1fr);overflow:hidden}.workspace-header{grid-column:1/-1;grid-row:1;display:flex;align-items:center;gap:10px;height:36px;padding:0 10px;background:var(--bg-panel);border-bottom:1px solid var(--line);min-width:0}.wordmark{font-family:'Architects Daughter','Segoe Print',cursive;font-size:19px;text-transform:uppercase;color:var(--ink);background:transparent;border:0;cursor:pointer}.wordmark strong{color:var(--accent);font-weight:400}.session-tab{height:27px;border:1px solid var(--line);border-bottom-color:var(--accent);background:var(--bg-soft);color:var(--ink);padding:0 10px;border-radius:4px 4px 0 0;font-family:ui-monospace,monospace;font-size:10px}.header-spacer{flex:1}.model-chip{border:1px solid var(--line);background:var(--bg);color:var(--ink-soft);border-radius:4px;padding:3px 8px;font-family:ui-monospace,monospace;font-size:9px}.canvas{grid-column:1;grid-row:2;position:relative;overflow:auto;background-color:var(--bg-canvas);background-image:radial-gradient(circle,var(--line-soft) 1px,transparent 1px);background-size:20px 20px}.canvas-stage{position:relative;width:1320px;height:760px;min-width:100%;min-height:100%}.wire-layer{position:absolute;inset:0;width:1320px;height:760px;pointer-events:none;overflow:visible}.wire-line{stroke:var(--accent);stroke-width:1.35;stroke-opacity:.42;fill:none}.graph-node{position:absolute;width:204px;height:134px;border:1px solid var(--line);border-radius:6px;background:var(--bg-panel);color:var(--ink);padding:0;display:flex;flex-direction:column;box-shadow:0 4px 14px rgba(0,0,0,.28);cursor:pointer;text-align:left;overflow:hidden}.graph-node:hover{border-color:var(--accent);transform:translateY(-1px)}.node-accent{height:3px;background:var(--accent)}.node-head{padding:9px 11px 5px;font-family:ui-monospace,monospace;font-size:9px;color:var(--ink-muted);letter-spacing:.1em;text-transform:uppercase}.node-title{padding:0 11px;font-family:'Instrument Serif',Georgia,serif;font-size:17px;line-height:1.1;color:var(--ink)}.node-value{margin-top:auto;padding:7px 11px 8px;border-top:1px solid var(--line-soft);font-family:ui-monospace,monospace;font-size:10px;color:var(--ok)}.canvas-heading{position:absolute;left:22px;top:18px;z-index:5;font-family:ui-monospace,monospace;font-size:9px;letter-spacing:.18em;color:var(--ink-muted);text-transform:uppercase}.canvas-toolbar{position:sticky;left:16px;bottom:14px;z-index:8;width:max-content;border:1px solid var(--line);background:var(--bg-panel);border-radius:5px;padding:5px 8px;font-family:ui-monospace,monospace;font-size:9px;color:var(--ink-soft)}.composer{position:sticky;left:50%;bottom:18px;transform:translateX(-50%);z-index:9;width:min(560px,calc(100% - 48px));border:1px solid var(--line);background:var(--bg-panel);border-radius:7px;padding:8px;box-shadow:0 8px 30px rgba(0,0,0,.4)}/*design-language-v1*//*node-params*/.node-params{display:flex;flex-direction:column;gap:1px;padding:2px 11px 4px}.node-param{display:flex;justify-content:space-between;gap:10px;font-family:ui-monospace,monospace;font-size:8.5px;line-height:1.5}.node-param-k{color:var(--ink-dim);letter-spacing:.02em}.node-param-v{color:var(--ink-soft);text-align:right;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:120px}.universal-library .universal-collection-row{grid-template-columns:minmax(0,1fr) 24px;gap:2px}.universal-library .library-row{min-height:40px;padding:6px 8px;border-radius:4px}.universal-library .library-row .universal-library-name{margin-top:2px;font-size:11.5px;font-weight:550}.universal-library .library-row .universal-library-fields,.universal-library .library-row .universal-library-meta{margin-top:2px;font-size:8px;line-height:1.4;color:var(--ink-dim)}.universal-collection-row .header-action{width:24px;height:24px;min-height:24px;align-self:center;border:0;background:transparent;color:var(--ink-dim);opacity:0;font-size:14px}.universal-collection-row:hover .header-action{opacity:.9}.universal-collection-row .header-action:hover{color:var(--accent);background:var(--accent-soft)}.graph-node{border-radius:5px;box-shadow:0 2px 10px rgba(0,0,0,.22)}.graph-node .node-head{height:24px;padding:6px 10px 4px;font-size:8px;letter-spacing:.14em}.graph-node .node-title{padding:8px 11px 2px;font-size:12.5px;font-weight:600;letter-spacing:.01em}.graph-node .node-value{padding:3px 11px 8px;font-family:ui-monospace,monospace;font-size:8.5px;letter-spacing:.02em;color:var(--ink-dim)}.graph-node:hover{transform:none;border-color:var(--line)}.graph-node:hover .node-accent{height:2px}.inspector .property-input{height:30px;font-family:ui-monospace,monospace;font-size:11px}.inspector textarea.property-input{font-family:Inter,system-ui,sans-serif}.inspector .property-label{font-size:8.5px;letter-spacing:.12em;text-transform:uppercase;color:var(--ink-dim)}.inspector .inspector-section{gap:8px;padding-top:10px}.inspector .connection-box{font-family:ui-monospace,monospace;font-size:10px;padding:8px 10px}.composer{border-radius:6px;padding:6px;background:color-mix(in srgb,var(--bg-panel) 92%,transparent);backdrop-filter:blur(6px)}.composer-input{height:30px;font-size:12.5px}.canvas-heading::after{content:'   scroll → zoom · drag → pan · shift-drag → select';color:var(--ink-dim);letter-spacing:.06em;text-transform:none;font-size:8px}.composer-agent-status{display:block;padding:4px 8px 2px;font-family:ui-monospace,monospace;font-size:10px;color:var(--accent)}.composer-input:disabled{opacity:.55}.composer-input{width:100%;height:34px;border:0;outline:0;background:transparent;color:var(--ink);padding:4px 7px}.inspector{grid-column:2;grid-row:2;min-height:0;overflow:auto;background:var(--bg-panel);border-left:1px solid var(--line);padding:14px 16px 20px}.inspector-panel[data-visible="False"]{display:none}.inspector-panel[data-visible="True"]{display:flex}.inspector-panel{flex-direction:column;gap:16px}.inspector-kicker{font-family:ui-monospace,monospace;font-size:9px;color:var(--accent);letter-spacing:.18em;text-transform:uppercase}.inspector-title{font-family:'Instrument Serif',Georgia,serif;font-size:22px;line-height:1.05}.inspector-meta{font-family:ui-monospace,monospace;font-size:9px;color:var(--ink-muted)}.inspector-section{border-top:1px solid var(--line-soft);padding-top:12px;display:flex;flex-direction:column;gap:10px}.inspector-heading{font-family:ui-monospace,monospace;font-size:9px;color:var(--ink-muted);letter-spacing:.18em;text-transform:uppercase}.property-row{display:flex;flex-direction:column;gap:5px}.property-label{font-family:ui-monospace,monospace;font-size:9px;color:var(--ink-muted);text-transform:uppercase;letter-spacing:.08em}.property-input{width:100%;height:30px;border:1px solid var(--line);border-radius:5px;background:var(--bg);color:var(--ink);padding:5px 8px;font-family:ui-monospace,monospace;font-size:11px;outline:0}.property-input:focus{border-color:var(--accent);box-shadow:0 0 0 1px var(--accent-soft)}.connection-box{border:1px solid var(--line);background:var(--bg);border-radius:6px;padding:10px 12px;font-family:ui-monospace,monospace;font-size:10px;color:var(--ink-soft)}.status-strip{grid-column:1/-1;grid-row:2;display:flex;align-items:center;gap:16px;padding:0 9px;background:var(--bg-deep);border-top:1px solid var(--line);font-family:ui-monospace,monospace;font-size:9px;color:var(--ink-muted)}.status-live{color:var(--ok)}@media(max-width:980px){.archhub-app{grid-template-columns:56px minmax(0,1fr)}.sidebar{grid-template-columns:56px}.library-panel{display:none}.workspace{grid-template-columns:minmax(0,1fr) 280px}}@media(max-width:720px){.workspace{grid-template-columns:1fr}.inspector{display:none}.composer{width:calc(100% - 32px)}}
.wire-layer{pointer-events:none}.wire-line{pointer-events:stroke;cursor:pointer}.wire-line:hover{stroke-opacity:1;stroke-width:2.4}.graph-node{cursor:grab}.graph-node:active{cursor:grabbing}.connection-box{overflow-wrap:anywhere}.home-surface{display:none;grid-column:2;grid-row:1;min-width:0;min-height:0;overflow:auto;background:var(--bg);padding:44px 52px 120px;position:relative}.archhub-app[data-mode="home"]{grid-template-columns:56px minmax(0,1fr)}.archhub-app[data-mode="home"] .sidebar{grid-template-columns:56px;width:56px}.archhub-app[data-mode="home"] .library-panel,.archhub-app[data-mode="home"] .workspace{display:none}.archhub-app[data-mode="home"] .home-surface{display:block}.home-masthead{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;padding-bottom:24px;border-bottom:1px solid var(--line)}.home-brand{font-family:'Architects Daughter','Segoe Print',cursive;font-size:36px;text-transform:uppercase;color:var(--ink)}.home-brand strong{color:var(--accent);font-weight:400}.home-subtitle{font-family:ui-monospace,monospace;font-size:9px;letter-spacing:.18em;color:var(--ink-muted);text-transform:uppercase}.home-section-title{margin:28px 0 12px;font-family:'Instrument Serif',Georgia,serif;font-size:22px}.home-session-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:12px;max-width:1040px}.home-session-card{min-height:148px;border:1px solid var(--line);border-radius:6px;background:var(--bg-panel);color:var(--ink);padding:15px;text-align:left;cursor:pointer;display:flex;flex-direction:column}.home-session-card:hover{border-color:var(--accent);background:var(--bg-soft)}.home-session-kicker{font-family:ui-monospace,monospace;font-size:9px;letter-spacing:.14em;color:var(--accent);text-transform:uppercase}.home-session-title{font-family:'Instrument Serif',Georgia,serif;font-size:21px;margin-top:8px}.home-session-meta{margin-top:auto;font-family:ui-monospace,monospace;font-size:9px;color:var(--ink-muted)}.home-composer{position:fixed;left:calc(56px + (100vw - 56px)/2);bottom:42px;transform:translateX(-50%);width:min(620px,calc(100vw - 100px));border:1px solid var(--line);border-radius:7px;background:var(--bg-panel);padding:9px;box-shadow:0 8px 30px rgba(0,0,0,.4)}.home-composer input{width:100%;height:36px;border:0;outline:0;background:transparent;color:var(--ink);padding:4px 8px}
"""

STYLESHEET += r"""
.cockpit-surface{display:none;grid-column:2;grid-row:1;min-width:0;min-height:0;overflow:auto;background:var(--bg);padding:28px 34px 60px}.archhub-app[data-mode="cockpit"]{grid-template-columns:56px minmax(0,1fr)}.archhub-app[data-mode="cockpit"] .sidebar{grid-template-columns:56px;width:56px}.archhub-app[data-mode="cockpit"] .library-panel,.archhub-app[data-mode="cockpit"] .workspace,.archhub-app[data-mode="cockpit"] .home-surface{display:none}.archhub-app[data-mode="cockpit"] .cockpit-surface{display:block}.cockpit-header{display:flex;align-items:center;gap:16px;padding-bottom:18px;border-bottom:1px solid var(--line)}.cockpit-title{font-family:'Instrument Serif',Georgia,serif;font-size:26px}.cockpit-subtitle{font-family:ui-monospace,monospace;font-size:9px;color:var(--ink-muted);letter-spacing:.14em}.cockpit-spacer{flex:1}.cockpit-run{border:1px solid var(--accent);border-radius:5px;background:var(--accent-soft);color:var(--accent);padding:7px 11px;cursor:pointer;font-family:ui-monospace,monospace;font-size:9px;text-transform:uppercase}.cockpit-command{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:8px;margin-top:18px;padding:10px;border:1px solid var(--line);border-radius:6px;background:var(--bg-panel)}.cockpit-command-input{height:34px;border:1px solid var(--line);border-radius:4px;background:var(--bg);color:var(--ink);padding:6px 9px;outline:0}.cockpit-command-input:focus{border-color:var(--accent)}.cockpit-command-route{font-family:ui-monospace,monospace;font-size:9px;color:var(--cyan);text-transform:uppercase;min-width:72px;text-align:center}.cockpit-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:10px;margin-top:18px}.cockpit-card{min-height:118px;border:1px solid var(--line);border-radius:6px;background:var(--bg-panel);padding:12px;display:flex;flex-direction:column;gap:8px}.cockpit-label{font-family:ui-monospace,monospace;font-size:9px;letter-spacing:.12em;color:var(--ink-muted);text-transform:uppercase}.cockpit-value{font-family:ui-monospace,monospace;font-size:11px;color:var(--ink);overflow-wrap:anywhere}.cockpit-domain-section{margin-top:24px}.cockpit-domain-grid{display:grid;grid-template-columns:repeat(3,minmax(220px,1fr));gap:1px;border:1px solid var(--line);background:var(--line)}.cockpit-domain-row{display:flex;align-items:center;justify-content:space-between;gap:12px;background:var(--bg-panel);padding:8px 10px}.cockpit-domain-name{font-size:12px}.cockpit-domain-value{font-family:ui-monospace,monospace;font-size:10px;color:var(--ok)}@media(max-width:1100px){.cockpit-grid{grid-template-columns:repeat(2,minmax(180px,1fr))}.cockpit-domain-grid{grid-template-columns:1fr}}@media(max-width:720px){.cockpit-command{grid-template-columns:1fr}.cockpit-command-route{text-align:left}}
"""

STYLESHEET += r"""
.wire-line{fill:none}.canvas-stage{transform-origin:0 0}.canvas-toolbar{display:flex;align-items:center;gap:6px}.node-select{position:absolute;right:6px;top:7px;width:18px;height:18px;border:1px solid var(--line);border-radius:3px;background:var(--bg);color:transparent;cursor:pointer;z-index:3}.node-select[data-active="True"]{border-color:var(--accent);background:var(--accent);color:white}.node-select[data-active="True"]::before{content:"\2713";font-size:11px}.node-ports{margin-top:auto;border-top:1px solid var(--line-soft);display:grid;grid-template-columns:1fr 1fr}.node-port{height:25px;border:0;background:transparent;color:var(--ink-muted);font-family:ui-monospace,monospace;font-size:8px;cursor:pointer;position:relative}.node-port:hover{color:var(--accent);background:var(--bg-soft)}.node-port-in{text-align:left;padding-left:18px}.node-port-out{text-align:right;padding-right:18px}.node-port::before{content:"";position:absolute;top:9px;width:7px;height:7px;border:1px solid currentColor;border-radius:50%;background:var(--bg-panel)}.node-port-in::before{left:5px}.node-port-out::before{right:5px}.node-port[data-pending="True"]{color:var(--accent);background:var(--accent-soft)}
"""
...
STYLESHEET += r"""
.lifecycle-head{display:flex;flex-direction:column;gap:6px}.lifecycle-head-meta{color:var(--ink-muted);font-size:8px;line-height:1.45}.lifecycle-divergence{border:1px solid var(--accent);background:var(--accent-soft);border-radius:5px;padding:8px 10px;color:var(--accent);font-family:ui-monospace,monospace;font-size:9px;line-height:1.45}
.operational-current{color:var(--ok);border-color:var(--ok)}.operational-action{min-height:30px;border:1px solid var(--accent);border-radius:5px;background:var(--accent-soft);color:var(--accent);font-family:ui-monospace,monospace;font-size:9px;text-transform:uppercase;cursor:pointer}.operational-action:disabled{border-color:var(--line);background:var(--bg);color:var(--ink-muted);cursor:not-allowed}
