...
# One project (WORKSPACE-STANDARD.md:489): the courts live in 13.NODE-LANGUAGE/node_courts
# and run against nodelang/ in the same checkout.
NL = os.path.join(_HERE, "..")
