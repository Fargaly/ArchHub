...
' Run the Python build script for Revit 2024, wait for it to finish (True), hidden (0)
Dim sCmd
sCmd = "cmd /c ""cd /d C:\Users\fargaly\00.ARCHUB\ArchHub\app && py do_build_2024.py"""
...
If oFSO.FileExists("C:\Users\fargaly\00.ARCHUB\ArchHub\build_output.txt") Then
    ...
    oFile.Close
    MsgBox sResult, 64, "Revit 2024 Build Result"
Else
